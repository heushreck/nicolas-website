<template>
  ...
  <div class="max-w-screen-lg flex flex-col justify-between mx-auto p-4">
    ...
    <FlowbiteAccordion :open-first-item="false" class="w-full">
        ...
        <FwbAccordionContent>
          <div>
            <p class="mb-2 text-gray-500 dark:text-gray-400">
              <a href="https://www.langchain.com/" target="_blank" class="text-blue-600 dark:text-blue-500 hover:underline">LangChain</a> is a comprehensive framework enabling the development of context-aware and reasoning-driven applications powered by language models, supported by Python and JavaScript libraries, templates, and deployment tools.
            </p>
      ...
      <FwbAccordionPanel>
        <FwbAccordionHeader class="border-gray-600 text-xl">
          <div class="flex flex-row">
            <img class="w-6 h-6 me-2" src="https://docs.ragas.io/en/stable/_static/ragas-logo.png" alt="Flowbite logo" />
            <div>Ragas</div>
          </div>
        </FwbAccordionHeader>
        <FwbAccordionContent>
          <div>
            <p class="mb-2 text-gray-500 dark:text-gray-400">
              <a href="https://docs.ragas.io/en/stable/" target="_blank" class="text-blue-600 dark:text-blue-500 hover:underline">Ragas</a> is a tool designed to assess and quantify the performance of Retrieval Augmented Generation (RAG) pipelines, which enhance language model applications by incorporating external data into their context.
            </p>
            <p class="text-gray-500 dark:text-gray-400">
      ...
      <FwbAccordionPanel>
        <FwbAccordionHeader class="border-gray-600 text-xl">
          <div class="flex flex-row">
            <svg class="w-6 h-6 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 150">
        ...
        <FwbAccordionContent>
          <div>
            <p class="mb-2 text-gray-500 dark:text-gray-400">
              <a href="https://vuejs.org/" target="_blank" class="text-blue-600 dark:text-blue-500 hover:underline">Vue.js</a> is a progressive JavaScript framework designed for building user interfaces and single-page applications, distinguished by its simplicity, flexibility, and fine-grained reactivity system that makes it easy to understand and integrate with other projects or libraries.
            </p>
            <p class="text-gray-500 dark:text-gray-400">
...
<script setup>
import FlowbiteAccordion from '../components/FwbAccordion/FwbAccordion.vue'
